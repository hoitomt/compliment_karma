...
Reward.create(:name => '$25 Gift Card', 
              :image_thumb => 'user_profile/reward_thumb.png',
              :image_mini => 'user_profile/reward_mini.png')
...
Accomplishment.create(:name => 'Trophy', 
                      :image_thumb => 'user_profile/trophy_thumb.png',
                      :image_mini => 'user_profile/trophy_mini.png')
Accomplishment.create(:name => 'Aspirant Badge',
                      :image_thumb => 'user_profile/badge_aspirant_thumb.png',
                      :image_mini => 'user_profile/badge_mini.png')
Accomplishment.create(:name => 'Ninja Badge',
                      :image_thumb => 'user_profile/badge_thumb.png',
                      :image_mini => 'user_profile/badge_mini.png')
